...
get_cpue_guild <- function(racebase_tables = list(
                       cruisedat = cruisedat,
                       haul = haul,
                       catch = catch
                     ),
                     # KYA changed
                       speciescodes = c(30060),#predator = "P.cod", #speciescode = 30060, # POP
                       model    = "EBS",
                       abundance.hauls = T    #survey_area = "AI"
                     ){ 
  ...
  sp_catch <- catch %>%
    filter(species_code %in% speciescodes)
...
##################################################################################
get_cpue_length_cons_guild <- function(racebase_tables = list(
                       cruisedat = cruisedat,
                       haul = haul,
                       catch = catch,
                       length = length
