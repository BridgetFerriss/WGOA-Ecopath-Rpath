...
#
#Quick anomaly generation code for primary production, this code was replaced by
#ROMS_output_WGOA_EGOA.R
#The code also transforms the temperature data to be used in the bioenergetic model
#------------------------------------------------------------------------------#
